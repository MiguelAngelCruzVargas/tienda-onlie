...
const RinesCamionetaPage = () => {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      queryParams.append('category', 2); // ID 2 = "Rines Camioneta"
  ...
  const breadcrumbItems = [
    { name: 'Inicio', path: '/' },
    { name: 'Rines para Camioneta', path: '/productos/camioneta' }
  ];
    ...
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      <div className="relative bg-black text-white">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: "url('https://i.pinimg.com/1200x/f4/99/99/f499994727d99cf5e368e5f3f7a0fd1b.jpg')", 
        ...
        <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
          {/* Se eliminó la sección de breadcrumbs que estaba aquí */}
          
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
              Rines Deportivos 
              <span className="text-yellow-500"> para Camioneta</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-300 mb-6">
              Transforma el aspecto y desempeño de tu camioneta con nuestra exclusiva colección de rines deportivos de alta calidad.
            </p>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {availableSizes.map((size) => (
                    <div
                      ...
                      className={`cursor-pointer flex items-center justify-center py-2 px-3 rounded-lg border text-center transition-all ${filters.sizes.includes(size)
          ...
          <div className="lg:w-3/4">
            <div className="bg-white rounded-xl shadow-md p-6 mb-6 border border-gray-100">
              <div className="flex flex-wrap justify-between items-center">
                <div>
                  <h1 className="text-2xl font-bold">Rines para Camioneta</h1>
                ...
                <div className="flex justify-center">
                  <nav className="flex items-center rounded-xl shadow-sm bg-white border border-gray-100 overflow-hidden" aria-label="Paginación">
                    ...
                    <button
                      ...
                      disabled={page === 1}
                      className={`relative flex items-center px-4 py-3 ${page === 1
                          ...
                          return (
                            <button
                              ...
                              className={`relative inline-flex items-center justify-center min-w-[3rem] py-3 
                                border-r border-gray-200 text-sm font-bold ${isCurrentPage
                    ...
                    <button
                      ...
                      className={`relative flex items-center px-4 py-3 ${page === totalPages
                        ? 'bg-gray-50 text-gray-400 cursor-not-allowed'
                        : 'bg-white text-gray-700 hover:bg-gray-50 hover:text-yellow-500'
            ...
            <div className="md:flex items-center">
              <div className="md:w-2/3 mb-8 md:mb-0 md:pr-8">
                <h2 className="text-3xl md:text-4xl font-extrabold mb-4">
                  ¿Quieres renovar el <span className="text-yellow-500">estilo</span> de tu camioneta?
                </h2>
...
export default RinesCamionetaPage;